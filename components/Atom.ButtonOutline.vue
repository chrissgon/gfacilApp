<template>
  <button
    @click.prevent="event"
    :disabled="isDisabled"
    :class="[getClasses.text, getClasses.border, { disabled: isDisabled }]"
    class="AtomButtonOutline w-full flex justify-center items-center font-medium px-4 rounded-md border-2 h-10 leading-none transparent"
  >
